...
function Player({
  ...
  //
  // IMPORTANT:
  // CameraController changes yawRef.
  // Player uses the same yawRef for movement.
  //
  // This keeps camera + movement synchronized.
  //
    ...
    const handleKeyDown = (event) => {
      ...
      if (key === "e") {
        ...
        const distanceToAbout =
          Math.sqrt(
            Math.pow(
              currentPosition.x - 4.1,
              2
            ) +
            Math.pow(
              currentPosition.z - 16.9,
              2
            )
          );
